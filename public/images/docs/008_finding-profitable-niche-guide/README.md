# Image Folder for Doc #008 - Finding Profitable Niche Guide

## Required Image

Upload the hero image for this documentation as:
- **Filename**: `hero.jpg`
- **Recommended size**: 1200x630px (2:1 ratio for social sharing)
- **Format**: JPG or PNG
